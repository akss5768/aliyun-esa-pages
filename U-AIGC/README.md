...
U-AIGC 是一个现代化的AI工具导航平台，汇集了各类AI工具，包括AI绘画、AI写作、AI视频等，为用户提供便捷的AI工具查找和使用服务。采用轻量化设计，基于localStorage存储，开箱即用。
...
- **多类型AI工具支持** - 支持AI绘画、AI写作、AI视频等多种类型的AI工具
- **分类浏览** - 按照功能分类整理AI工具，便于用户快速查找
- **智能搜索** - 提供便捷的搜索功能，快速定位所需AI工具
- **书签收藏** - 支持收藏常用AI工具，方便快速访问
...
项目当前使用浏览器 localStorage 进行数据存储，无需额外配置。数据持久化存储在用户本地，保护用户隐私。
...
- **数据持久化**: 用户收藏和偏好设置持久化存储在本地，保护用户隐私

数据完全存储在用户设备上，无需担心数据泄露风险。

## 数据结构

项目当前使用浏览器 localStorage 存储数据：

- AI工具数据 - 包括工具名称、描述、链接、分类等信息
- 用户收藏 - 保存用户收藏的AI工具
- 本地配置 - 保存用户的界面偏好设置

数据完全存储在用户浏览器中，确保隐私安全。
